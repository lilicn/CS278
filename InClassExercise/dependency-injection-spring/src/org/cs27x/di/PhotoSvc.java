...
public class PhotoSvc {
	...
	private PhotoStorage photoStorage_;
	

	public PhotoSvc(TagManager tagMgr, PhotoStorage pStore){
		this.tagManager_ = tagMgr;
		this.photoStorage_ = pStore;
	}
	...
	public String addPhoto(MultipartFile imgdata) throws Exception {
		//Photo photo = null;
		//return photo.getId();
		return photoStorage_.storePhoto(imgdata.getBytes()).getId();
	...
	public List<Photo> imageList(){
		...
		//return photos;
		return photoStorage_.listPhotos();
	}
	...
	public List<String> getPhotoTest(String tag){
		return tagManager_.listPhotosWithTag(tag);
	}
