...
public class QRCodeObjRefExtractor implements ObjRefExtractor {
	...
	public ExternalObjRef extract(String data) {
		...
		/**
		 * Asgn Step 7: Use the data above to create an instance of your
		 * ExteranlObjRef implementation and return it.
		 * 
		 */
		ExternalObjRef externalObjRef = new ExternalObjRefImpl();
		externalObjRef.setObjRef(oref);
		externalObjRef.setPubSubHost(server);
		return externalObjRef;
	}
